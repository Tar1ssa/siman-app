                        ...
                        <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-floating ">
                                        <input value="{{  old('kode_satker') }}" type="text" class="form-control" id="floatingName" placeholder="Kode Satker" name="kode_satker">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating ">
                                        <input value="{{  old('nama_satker') }}" type="text" class="form-control" id="floatingName" placeholder="Nama Satker" name="nama_satker">
