                                    ...
                                    <label for="unitkerja_id" class="form-label">Unit Kerja</label>
                                            <select
                                                ...
                                                @foreach ($unitkerja as $keyunitkerja)
                                                    ...
                                                    <option value="{{ $keyunitkerja->id }}" {{ $lokasi->unit_kerja_id == $keyunitkerja->id ? 'selected' : '' }}>{{ $keyunitkerja->name }}</option>
                                                @endforeach
                                            </select>
                                </div>
                                <div class="mb-3">
                                    <div class="form-floating ">
                                        <input value="{{  $lokasi->name }}" type="text" class="form-control" id="floatingName" placeholder="Nama kode lokasi" name="name">
