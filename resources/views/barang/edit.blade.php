                        ...
                        <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-floating ">
                                        <input value="{{  $barang->kode_barang }}" type="text" class="form-control" id="floatingName" placeholder="Kode kode barang" name="kode_barang">
                                        <label for="floatingName">Kode barang</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="form-floating ">
                                        <input value="{{  $barang->nama_barang }}" type="text" class="form-control" id="floatingName" placeholder="Nama kode barang" name="nama_barang">
