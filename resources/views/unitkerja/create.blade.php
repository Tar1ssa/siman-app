            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Tambah Unit Kerja</li>
                </ul>
              </div>
              <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-floating ">
                                        <input value="{{  old('name') }}" type="text" class="form-control" id="floatingName" placeholder="Nama Unit Kerja" name="name">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating ">
                                        <input value="{{  old('nameId') }}" type="text" class="form-control" id="floatingName" placeholder="Kode Unit Kerja" name="nameId">
