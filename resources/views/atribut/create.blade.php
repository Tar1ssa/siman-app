                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="key" placeholder="(contoh: ram)">
                                <small>(huruf kecil)</small>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Label</label>
                                <input class="form-control" type="text" name="label" placeholder="(contoh: RAM)">
                                <small>(huruf besar)</small>
                            </div>
                            <div class="mb-3">
